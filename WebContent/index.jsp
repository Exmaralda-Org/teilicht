...
<body>
  ...
  <p>
    This page contains the <a
      ...
      guidelines</a>. Currently, we have:
  </p>
  <ul>
    <li>a service for normalizing TEI input at <a
      href="services/normalize"><code>services/normalize</code></a></li>
  </ul>
  <p>(Caveat: Links to services are not clickable and are only
    present for ease of copying!)</p>
</body>
</html>